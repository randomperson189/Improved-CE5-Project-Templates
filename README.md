...
2. Copy the **Templates** folder and then paste it into this directory "**%localappdata%\Programs\CRYENGINE Launcher\Engines\crytek\cryengine-57-lts\5.7.1**" replace if prompted
